...
export default function QuestionBar({timeLeft}:propType) {
  ...
  if (!session) return
  return (
    <div id="game-question-container" className="bg-background-100 hidden relative z-10 sm:text-base text-sm text-white w-full sm:flex justify-between items-center border-b-2 border-background-200 gap-6 p-3 ">
