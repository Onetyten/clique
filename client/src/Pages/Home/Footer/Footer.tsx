...
export default function Footer() {
  ...
  return (
    <footer className="px-3 sm:px-12 py-6 text-left w-full text-sm lg:text-base flex flex-wrap bg-background/80 backdrop-blur-[3px] items-center justify-between gap-6">
        ...
        <div className="flex flex-1 sm:flex-none justify-center items-center lg:w-auto gap-6">
        {links.map((link) => (
