...
const cliqueCreateSchema = joi_1.default.object({
    cliqueKey: joi_1.default.string().min(3).max(50).messages({ "string.empty": "key is required", "any.required": "Key must be provided" }),
    cliqueName: joi_1.default.string().min(3).max(50).messages({ "string.empty": "CliqueName is required" }),
...
exports.default = cliqueCreateSchema;
